...
def get_known_blocks() -> np.ndarray:
    ...
    symbols = get_symbols_from_bitstream(get_non_repeating_bits(BITS_PER_SYMBOL * SYMBOLS_PER_BLOCK * INFORMATION_BLOCKS // INFORMATION_BLOCKS_PER_FRAME, 1), skip_encoding=True)
